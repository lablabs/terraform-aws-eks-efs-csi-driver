...
moved {
  ...
  to   = module.addon-irsa["efs-csi-driver"].aws_iam_role.this
}

moved {
  from = aws_iam_policy.this
  to   = module.addon-irsa["efs-csi-driver"].aws_iam_policy.this
}

moved {
  from = aws_iam_role_policy_attachment.this
  to   = module.addon-irsa["efs-csi-driver"].aws_iam_role_policy_attachment.this
}
